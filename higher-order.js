...
//Code Here
let myStrongest = monstersInYourPocket.filter(monst=>monst.CP>200);
...
console.log("bob",bobsTotal)
var tot = []
for (i=0;i<bobsTotal.length;i++){
  tot.push(bobsTotal[i].price);
}
bobsTotal = tot.reduce((accum,num)=>accum+num);
